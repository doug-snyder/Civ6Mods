...
INSERT INTO IconDefinitions
		(Name,										Atlas,							'Index'	)
VALUES	('ICON_CIVILIZATION_MS2099_CIVNAME',		'ICON_ATLAS_MC_OLMEC',			0		),
		('ICON_LEADER_MS2099_CIVLEADER',			'ICON_ATLAS_MC_PO_NGBE',		0		),
		('ICON_UNIT_MS2099_CIVUNIT_PORTRAIT',		'ICON_ATLAS_MC_WEREJAGUAR',		0		),
		('ICON_UNIT_MS2099_CIVUNIT',				'ICON_ATLAS_MC_WEREJAGUAR',		1		);
