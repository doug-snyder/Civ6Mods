...
VALUES	('TRAIT_CIVILIZATION_IMPROVEMENT_CIVNAME_CIVIMPROVEMENT', 'CIVILIZATION_MS2099_CIVNAME');
...
VALUES	
		(
			...
			-- Building Info
			1, 0,
			'TRAIT_CIVILIZATION_IMPROVEMENT_CIVNAME_CIVIMPROVEMENT',
			'CIVIC_MYSTICISM',
			-- Plunder Info
			'PLUNDER_SCIENCE', 1,
			-- Housing Info
...
VALUES	('TRAIT_CIVILIZATION_IMPROVEMENT_CIVNAME_CIVIMPROVEMENT', 'CIVNAME_CIVIMPROVEMENT_GREATPERSON');
...
VALUES	('CIVNAME_#_CIVIMPROVEMENT', 'REQUIREMENTSET_TEST_ALL'),
		('PLOT_HAS_CIVNAME_CIVIMPROVEMENT', 'REQUIREMENTSET_TEST_ALL');
...
VALUES	('CIVNAME_#_CIVIMPROVEMENT', 'CIVNAME_#_CIVIMPROVEMENT_REQUIREMENT'),
		('PLOT_HAS_CIVNAME_CIVIMPROVEMENT',	'PLOT_HAS_CIVNAME_CIVIMPROVEMENT_REQUIREMENT');
...
VALUES	('CIVNAME_#_CIVIMPROVEMENT_REQUIREMENT', 'REQUIREMENT_COLLECTION_COUNT_ATLEAST'),
		('PLOT_HAS_CIVNAME_CIVIMPROVEMENT_REQUIREMENT', 'REQUIREMENT_PLOT_IMPROVEMENT_TYPE_MATCHES');
...
VALUES	('CIVNAME_#_CIVIMPROVEMENT_REQUIREMENT', 'CollectionType', 'COLLECTION_CITY_PLOT_YIELDS'),
		...
		('CIVNAME_#_CIVIMPROVEMENT_REQUIREMENT', 'RequirementSetId', 'PLOT_HAS_CIVNAME_CIVIMPROVEMENT'),
		('PLOT_HAS_CIVNAME_CIVIMPROVEMENT_REQUIREMENT', 'ImprovementType', 'IMPROVEMENT_CIVIMPROVEMENT');
