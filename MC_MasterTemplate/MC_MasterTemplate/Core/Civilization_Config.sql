...
INSERT INTO	Types
			(Type,							Kind					)
VALUES		('CIVILIZATION_MRSHAKE_CIVNAME',		'KIND_CIVILIZATION'		);
...
VALUES		(
			...
			'LOC_CIVILIZATION_MRSHAKE_CIVNAME_NAME', -- Name
...
VALUES	('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_MOUNTAIN_CORDILLERA_NEOVOLCANICA'	),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_MOUNTAIN_MEXICAN_PLATEAU'			),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_MOUNTAIN_SIERRA_MADRE_OCCIDENTAL'	),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_MOUNTAIN_SIERRA_MADRE_DEL_SUR'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_MOUNTAIN_SIERRA_MADRE_ORIENTAL'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_MOUNTAIN_CHIAPAS'					),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_MOUNTAIN_MONTANAS_GUATEMALA'			);
...
VALUES	('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_RIVER_GRANDE'			),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_RIVER_USUMACINTA'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_RIVER_NAZAS'				),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_RIVER_AGUANAVAL'			),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_RIVER_BALSAS'			),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_RIVER_CULIACAN'			),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_RIVER_LERMA'				),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_RIVER_GRANDE_DE_SANTIAGO'),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_RIVER_FUERTE'			),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_RIVER_CONCHOS'			);
...
VALUES	('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_LAKE_LAKE_TEXCOCO'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_LAKE_CHAPALA'			),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_LAKE_PATZCUARO'			),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_LAKE_BACALAR'			),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_LAKE_LAGUNA_CATEMACO'	),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_LAKE_EL_CARACOL'			);
...
VALUES	('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_SEA_GULF_OF_CALIFORNIA'	),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_SEA_GULF_OF_MEXICO'		);
...
VALUES	('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_DESERT_SONORAN'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_DESERT_LA_GUAJIRA'	),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_DESERT_SECHURA'		);
...
VALUES	('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_VOLCANO_PICO_DE_ORIZABA'	),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_VOLCANO_TAJUMULCO'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_VOLCANO_TACANA'			),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_VOLCANO_SANTIAGUITO'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'NAMED_VOLCANO_CHAPARRASTIQUE'	);
...
VALUES	('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITY_NAME_MRSHAKE_CIVNAME_1'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITY_NAME_MC_OLMEC_2'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITY_NAME_MC_OLMEC_3'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITY_NAME_MC_OLMEC_4'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITY_NAME_MC_OLMEC_5'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITY_NAME_MC_OLMEC_6'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITY_NAME_MC_OLMEC_7'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITY_NAME_MC_OLMEC_8'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITY_NAME_MC_OLMEC_9'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITY_NAME_MC_OLMEC_10'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITY_NAME_MC_OLMEC_11'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITY_NAME_MC_OLMEC_12'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITY_NAME_MC_OLMEC_13'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITY_NAME_MC_OLMEC_14'		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITY_NAME_MC_OLMEC_15'		);
...
VALUES	('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_MALE_1',		0 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_MALE_2',		0 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_MALE_3',		0 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_MALE_4',		0 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_MALE_5',		0 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_MALE_6',		0 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_MALE_7',		0 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_MALE_8',		0 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_MALE_9',		0 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_MALE_10',		0 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_FEMALE_1',	1 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_FEMALE_2',	1 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_FEMALE_3',	1 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_FEMALE_4',	1 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_FEMALE_5',	1 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_FEMALE_6',	1 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_FEMALE_7',	1 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_FEMALE_8',	1 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_FEMALE_9',	1 		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CITIZEN_MC_OLMEC_FEMALE_10',	1 		);
...
VALUES	('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CIVINFO_LOCATION',		'LOC_CIVINFO_MC_OLMEC_LOCATION',		10			),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CIVINFO_SIZE',			'LOC_CIVINFO_MC_OLMEC_SIZE',			20			),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CIVINFO_POPULATION',	'LOC_CIVINFO_MC_OLMEC_POPULATION',		30			),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'LOC_CIVINFO_CAPITAL',		'LOC_CIVINFO_MC_OLMEC_CAPITAL',			40			);
...
VALUES	('CIVILIZATION_MRSHAKE_CIVNAME',	'TERRAIN_PLAINS',		1		),
		('CIVILIZATION_MRSHAKE_CIVNAME',	'TERRAIN_GRASS',		5		);

INSERT INTO	StartBiasFeatures
		(CivilizationType,			FeatureType,			Tier	)
VALUES	('CIVILIZATION_MRSHAKE_CIVNAME',	'FEATURE_FLOODPLAINS',	4		);

INSERT INTO	StartBiasResources
		(CivilizationType,			ResourceType,			Tier	)
VALUES	('CIVILIZATION_MRSHAKE_CIVNAME',	'RESOURCE_JADE',		3		);

INSERT INTO	StartBiasRivers
		(CivilizationType,				Tier	)
VALUES	('CIVILIZATION_MRSHAKE_CIVNAME',		2		);
