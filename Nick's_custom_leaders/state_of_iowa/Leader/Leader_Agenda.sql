...
INSERT INTO Types
			(Type,								Kind			)
VALUES		('TRAIT_AGENDA_MS2099_CIVLEADER',	'KIND_TRAIT'	);
...
VALUES		('TRAIT_AGENDA_MS2099_CIVLEADER',	'AGENDA_MODIFIER_MS2099_CIVLEADER_UNHAPPY'	),
			('TRAIT_AGENDA_MS2099_CIVLEADER',	'AGENDA_MODIFIER_MS2099_CIVLEADER_HAPPY'	);
...
VALUES		('AGENDA_MODIFIER_MS2099_CIVLEADER_UNHAPPY',	'Sample',	'LOC_TOOLTIP_SAMPLE_DIPLOMACY_ALL'	),
			('AGENDA_MODIFIER_MS2099_CIVLEADER_HAPPY',		'Sample',	'LOC_TOOLTIP_SAMPLE_DIPLOMACY_ALL'	);
...
VALUES	('AGENDA_MODIFIER_MS2099_CIVLEADER_UNHAPPY',	'InitialValue',					-5														),
		('AGENDA_MODIFIER_MS2099_CIVLEADER_UNHAPPY',	'IncrementValue',				-1														),
		('AGENDA_MODIFIER_MS2099_CIVLEADER_UNHAPPY',	'IncrementTurns',				-10														),
		('AGENDA_MODIFIER_MS2099_CIVLEADER_UNHAPPY',	'MaxValue',						-25														),
		('AGENDA_MODIFIER_MS2099_CIVLEADER_UNHAPPY',	'StatementKey',					'LOC_DIPLO_WARNING_LEADER_MS2099_CIVLEADER_REASON_ANY'	),
		('AGENDA_MODIFIER_MS2099_CIVLEADER_UNHAPPY',	'SimpleModifierDescription',	'LOC_DIPLO_MODIFIER_MS2099_CIVLEADER_UNHAPPY'			),
	
		('AGENDA_MODIFIER_MS2099_CIVLEADER_HAPPY',		'InitialValue',					5														),
