...
VALUES	
		(
			...
			1,															-- Buildable
			0,															-- SameAdjacentValid
			'TRAIT_CIVILIZATION_IMPROVEMENT_STATE_OF_IOWA_CIVIMPROVEMENT',	-- TraitType
...
VALUES	('TRAIT_CIVILIZATION_IMPROVEMENT_STATE_OF_IOWA_CIVIMPROVEMENT', 	'OLMEC_COLOSSAL_HEAD_GREAT_ARTIST'	);
